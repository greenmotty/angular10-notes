...
export class NoteService {
  ...
  private findNote(note: NoteModel): number {
    return this.NOTES.findIndex((n: NoteModel) => n.id === note.id);
  }
  ...
  public getNotes(): NoteModel[] {
    ...
    return this.NOTES.slice().sort((a: NoteModel, b: NoteModel) => b.date.getTime() - a.date.getTime());
  }

  public addNote(note: NoteModel): void {
    const newNote = new NoteModel();
    newNote.date = new Date();
    newNote.id = this.getTimestamp();
